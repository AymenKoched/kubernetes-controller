...
import (
	...
	"github.com/AymenKoched/kubernetes-controller-interview/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "d7771702.aymenkoched",
	...
	if err := (&controller.SlackMessageReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "SlackMessage")
		os.Exit(1)
	}
